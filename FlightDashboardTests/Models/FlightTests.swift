...
//        XCTAssertEqual(ExampleFlights.empty.state, .upcoming)
//        
//        XCTAssertEqual(ExampleFlights.empty.state, .upcoming)
//        XCTAssertEqual(ExampleFlights.boarding().state, .boarding)
//        XCTAssertEqual(ExampleFlights.scheduled().state, .upcoming)
//        XCTAssertEqual(ExampleFlights.inflight().state, .inflight)
//        XCTAssertEqual(ExampleFlights.landed().state, .landed)
//    }
}
